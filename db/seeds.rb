...
c21 = Card.create :model => 'GeForce RTX 2060 Super', :hashrate => 40.00, :power => 140, :gpu_maker => 'NVIDIA'
c22 = Card.create :model => 'GeForce RTX 2070 Super', :hashrate => 40.00, :power => 140, :gpu_maker => 'NVIDIA'
c23 = Card.create :model => 'GeForce RTX 2080 Super', :hashrate => 41.00, :power => 160, :gpu_maker => 'NVIDIA'
